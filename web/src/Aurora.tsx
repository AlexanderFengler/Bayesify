...
// Its colors come from the active theme variant (teal default / indigo dark), so toggling the theme
// re-paints it. Several over-sized radial pools drift over a base gradient, each on its own path so
// the colors merge and separate organically. Falls back to a flat fill for reduced-motion users.
