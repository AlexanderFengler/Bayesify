...
- Overall rubric ordering: the 15-step / three-phase / four-question structure is the strongest direct evidence that the workflow is intentionally checklist-shaped, supporting Bayesify scoring papers step-by-step (S1-S10).
