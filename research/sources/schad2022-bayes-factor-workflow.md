...
- Grounds rubric S6 (verified 3-0): the six numbered steps above are the canonical checklist Bayesify scores BF-reporting papers against, including the "run bridge sampling at least twice on the same data" stability requirement.
