...
def _job_payload(job: jobsmod.Job) -> dict:
    return {
        ...
        # Trusted-override overlay provenance: the corrections applied to the displayed `result` and
        # the pre-overlay engine coverage/quality (so the report can show what changed).
