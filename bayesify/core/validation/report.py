...
from bayesify.core.schema import PaperClassLabel, RelevanceLabel, ScoredResult, StepStatus
from bayesify.core.score import StepCalc, coverage_quality_from_weighted_steps, step_weight
from bayesify.core.validation.human_report import GoldTier, HumanReport
...
def to_markdown(report: ValidationReport) -> str:
    ...
    lines += [
        f"# Bayesify validation — {report.rubric_profile} profile",
        "",
